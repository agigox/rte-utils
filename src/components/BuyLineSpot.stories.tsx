...
const meta: Meta<typeof BuyLineSpot> = {
  title: 'Components/BuyLineSpot',
  component: BuyLineSpot,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
export const StatusComparison: Story = {
  ...
  render: (args) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '100%' }}>
      <BuyLineSpot {...args} title="Achat Accepté" showStatus="accepted" />
      <BuyLineSpot {...args} title="Achat Partiel" showStatus="partial" />
      <BuyLineSpot {...args} title="Achat Refusé" showStatus="refused" />
    </div>
  ),
  parameters: {
    docs: {
