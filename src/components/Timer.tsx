        ...
        {user === 'admin' && (
          <div className="timer-controls-section">
            ...
            <button
              ...
              title={isFrozen ? 'Frozen' : isRunning ? 'Pause' : 'Start'}
              disabled={isFrozen}
            >
              {isRunning ? (
                <svg
