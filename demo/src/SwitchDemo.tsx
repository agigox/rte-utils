  ...
  return (
    <div style={{ padding: '20px', maxWidth: '600px' }}>
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Switch checked={powerSwitch} onChange={setPowerSwitch} showIcon={true} />
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Switch checked={powerSwitch} onChange={setPowerSwitch} showIcon={false} />
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Switch checked={true} showIcon={true} label="This label won't show" />
            <span>Both showIcon=true and label provided → Icon is shown</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Switch checked={true} showIcon={false} label="This label will show" />
